...
import com.simulator.exception.model.AttributeMessage;
...
public class ControllerExceptionHandler {
  ...
  public ResponseEntity<ExceptionResponse> constraintViolationException(
    ...
    ExceptionResponse err =
        new ExceptionResponse(HttpStatus.BAD_REQUEST, VALIDATION_EXCEPTION_MSG, attributeMessages);
  ...
  @ResponseBody
  public ResponseEntity<ExceptionResponse> handlingValidationException(
      ValidationException validationException) {
    ExceptionResponse err =
        new ExceptionResponse(HttpStatus.BAD_REQUEST, validationException.getMessage());
  ...
  @ResponseBody
  public ResponseEntity<ExceptionResponse> handlingMissingRequestHeaderException(
      MissingRequestHeaderException missingRequestHeaderException) {
    ExceptionResponse err =
        new ExceptionResponse(HttpStatus.BAD_REQUEST, missingRequestHeaderException.getMessage());
